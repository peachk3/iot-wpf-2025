...
namespace WpfBookRentalShop01.ViewModels
{
    public partial class BookGenreViewModel : ObservableObject
    {
        ...
        private async void InitValiable()
        {
        ...
        public async void DelData()
        {
            ...
            {
                Common.LOGGER.Error(ex.Message);
                await this.dialogCoordinator.ShowMessageAsync(this, "오류", "ex.Messsage");

            }
            LoadGridFromDb();   // 저장이 끝난후 다시 DB내용을 그리드에 그리기
        }
    }
}
